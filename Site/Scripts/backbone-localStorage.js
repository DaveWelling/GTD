...
(function () {
	...
	function getTransactionsFromStorage() {
		...
		return (transactionIndex && transactionIndex.split(",")) || [];
	};
	...
	Backbone.LocalStorage = window.Store = function (name) {
		...
		this.transactions = getTransactionsFromStorage();
	};
	...
	_.extend(Backbone.LocalStorage.prototype, {
		...
		save: function () {
			...
			this.localStorage().setItem("transactionIndex", this.transactions.join(","));
		},

		// Add a model, giving it a (hopefully)-unique GUID, if it doesn't already
		// have an id of it's own.
		// TODO: See about changing transaction ID to be new GUID rather than model.ID
		create: function (model) {
			...
			this.localStorage().setItem(currentTime, JSON.stringify({
			...
			this.transactions.push(currentTime);
